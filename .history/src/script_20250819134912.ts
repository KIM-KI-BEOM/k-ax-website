...
class SearchManager {
    ...
    private highlightResults(): void {
        this.searchResults.forEach((elements, sectionId) => {
...
// TypeScript 모듈 export (필요시)
export {
    AnimationManager, COMPANY_INFO, FormManager, NEWS_DATA, NavigationManager, NewsManager, PerformanceMonitor, SearchManager,
    ThemeManager, WebsiteState
};
