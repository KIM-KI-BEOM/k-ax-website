...
const COMPANY_INFO: CompanyInfo = {
    name: '(주)케이에이엑스',
    address: '서울특별시 강남구 자곡동 650 413호',
    phone: '',
    email: 'info@k-ax.com',
...
const NEWS_DATA: NewsItem[] = [
    {
        date: '2025.08.19',
        title: '(주)케이에이엑스 법인 설립 공지',
        content: '(주)케이에이엑스(Korea AI Transformation)가 2025년 8월 15일 법인으로 설립되었습니다. 앞으로 혁신적인 AI 기술로 고객 여러분의 비즈니스 성장을 함께하겠습니다.',
        isImportant: true
    }
];
